...
import { LoadingIndicator } from "./Tabs/LoadingIndicator";
import { 
  TagGeneratorTab, 
  MetadataTab, 
  MarkdownEditorTab,
...
export function DashboardTabs({
  ...
  // Bridge functions for handling external source URL
  const handleSaveDraft = onSaveDraft
